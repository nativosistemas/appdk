...
function ResultadoCarrito(props) {
        ...
        <>
            ...
            <div className="card">
                ...
                <div className="card-body card-body-box-sizing">
                    <Resultado ref={refResultado} modulos={props.farmaciaModulos.modulos} farmacia={props.farmaciaModulos.farmacia} refreshMontoAhorroGeneral={refreshMontoAhorroGeneral_pedidos} isPromociones={false} isCarrito={props.isCarrito} ></Resultado>
                </div>
...
export default ResultadoCarrito;
