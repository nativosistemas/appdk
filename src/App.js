      ...
      <div className="app container-fluid">
        <nav className="navbar navbar-expand-lg navbar-light bg-light">
          <div className="container-fluid">
            ...
            <Link className="navbar-brand" to="/laboratorio" >
            ...
            <div className={"collapse navbar-collapse " + (!isNavCollapsed ? 'collapseShow' : '')} id="navbarText">

              <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                <li className="nav-item" activeClassName="active" onClick={(e) => onClickCerrarMenu(e)}>
                ...
                <li className="nav-item" activeClassName="active" onClick={(e) => onClickCerrarMenu(e)}>
                  <Link className="nav-link" to="/cargadatosclientes" data-toggle="collapse" data-target=".navbar-collapse.show">Carga de datos del cliente</Link>
                </li>
                <li className="nav-item" activeClassName="active" onClick={(e) => onClickCerrarMenu(e)}>
        ...
        <div className={"alert alert-warning alert-dismissible fade show " + (isAlert ? 'Alert_block' : 'Alert_none')} role="alert">
          <div>
          ...
          <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close" onClick={handleCerrarAlert}></button>
        </div>
        <Switch>
