...
import { isLoggedIn, getDatosCliente_util, setDatosCliente_util, getDatosCliente_Responsable_util, getDatosCliente_urlEditar_util } from './utils';
...
function CargaDatosClientesGrillaResponsableEditar(props) {
    ...
    function get_state() {
        var result = getDatosCliente_Responsable_util();
        var paramsURL = getDatosCliente_urlEditar_util();
        if (paramsURL != -1) {
            var o = getDatosCliente_util();
            result = o.listaResponsable[paramsURL]
            //result.cdr_NombreApellido = 'DIOS';            
        }
        return result;
    }
    ...
    function onClickGrabar(e) {
        ...
        if (paramsURL == -1) {
            ...
            o.listaResponsable[paramsURL] = state;
        }
